...
fork from [capture-web](https://github.com/sindresorhus/capture-web)
...
await captureWebsite.file('https://sindresorhus.com', 'screenshot.png', {
	headers: {
		'x-powered-by': 'https://github.com/sindresorhus/capture-web'
	}
});
```
...
- [capture-web-cli](https://github.com/sindresorhus/capture-web-cli) - CLI for this module
